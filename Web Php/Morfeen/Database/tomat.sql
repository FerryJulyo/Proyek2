...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2020 at 07:07 PM
...
(80, 'Marmar ', 'Pcs', '200', 50, 'marmerempe.jpg');
...
(101, 27, 59, 'hh', 'Jl. sembarang', '65145', 'Hoodie', 'Hitam', 'XL', 295000, 2360000, 'g1.jpeg', '2020-11-09 14:04:33', 8, 'Pesanan Selesai');
...
--
ALTER TABLE `addcart`
  MODIFY `idadd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `barang`
  MODIFY `idbarang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `customer`
  MODIFY `idcus` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
COMMIT;
