      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto order-md-2 align-self-start title-section mb-5 col-12 title-section text-center mb-5 col-12">
            ...
            <h1 class="site-navbar site-menu">Toko Material</h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="title-section mb-5">
          <h2 class="text-uppercase"><span class="d-block">Discover</span> Tomat Collections</h2>
        </div>
        <div class="row align-items-stretch">
          <div class="col-lg-4">
          <div class="product-item sm-height  bg-gray">
              <img src="images/semen.jpg" alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-4">
            <div class="product-item sm-height bg-gray mb-4">
              <img src="images/keramikikema.jpg" alt="Image" class="img-fluid">
            </div>
            </div>
            
            <div class="col-lg-4">
            <div class="product-item sm-height bg-gray">
              <img src="images/batubata.jpg" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto order-md-2 align-self-start">
            <div class="site-block-cover-content">
            <h2 class="sub-title">#toko material</h2>
            <h1>New Marmer Light Emperador </h1>
            </div>
          </div>
          <div class="col-md-6 order-1 align-self-end">
            <img src="images/marmerempe.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
