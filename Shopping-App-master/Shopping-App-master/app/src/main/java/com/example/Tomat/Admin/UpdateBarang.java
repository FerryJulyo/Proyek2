        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                db.execSQL("update barang set nama_barang='"+
                        text2.getText().toString() +"', stock='" +
                        text3.getText().toString()+"', satuan='"+
                        text4.getText().toString() +"', harga='" +
                        text5.getText().toString() + "' where kode_barang='" +
                        text1.getText().toString()+"'");
                Toast.makeText(getApplicationContext(), "Barang Berhasil Diupdate", Toast.LENGTH_LONG).show();
